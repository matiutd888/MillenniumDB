...
template <bool MULTIPLE_FINAL> bool BFSMultipleStarts<MULTIPLE_FINAL>::_next() {
...
BFSMultipleStarts<MULTIPLE_FINAL>::expand_neighbors(
...
template <bool MULTIPLE_FINAL>
void BFSMultipleStarts<MULTIPLE_FINAL>::accept_visitor(
