...
void BindingIterPrinter::visit(Paths::Any::BFSMultipleStartsNaiveParallel<false>& binding_iter) {
    std::stringstream ss;
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper("Paths::Any::BFSMultipleStartsNaiveParallel<false>", *this, binding_iter, ss.str());
    os << ")\n";
}

void BindingIterPrinter::visit(Paths::Any::BFSMultipleStartsNaiveParallel<true>& binding_iter) {
    std::stringstream ss;
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper("Paths::Any::BFSMultipleStartsNaiveParallel<true>", *this, binding_iter, ss.str());
    os << ")\n";
}
...
void BindingIterPrinter::visit(Paths::Any::BFSMultipleStartsOptimized<false>& binding_iter) {
    std::stringstream ss;
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper("Paths::Any::BFSMultipleStartsOptimized<false>", *this, binding_iter, ss.str());
    os << ")\n";
}

void BindingIterPrinter::visit(Paths::Any::BFSMultipleStartsOptimized<true>& binding_iter) {
    std::stringstream ss;
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper("Paths::Any::BFSMultipleStartsOptimized<true>", *this, binding_iter, ss.str());
    os << ")\n";
}
/////////////
